struct POMG
    ...
    O_f  # joint observation function
    R  # joint reward function
end

Base.@kwdef mutable struct CryingBaby
...
function transition(pomg::BabyPOMG, s, a, s1)
...
function joint_observation(pomg::BabyPOMG, a, s1, o)
...
function POMG(pomg::BabyPOMG)
   return POMG(
       ...
       (s, a, s1) -> transition(pomg, s, a, s1),
       (a, s1, o) -> joint_observation(pomg, a, s1, o),
